---
title: "بررسی و خلاصه‌ی دایره‌المعارفی «نمونه‌های نخستین انسان و نخستین پادشاه در تاریخ افسانه‌ای ایرانیان»"
...
در قدیمی‌ترین لایه‌های اساطیر ایرانی، تاریخ بشریت با کیومرث (گَیومَرَتَن در اوستا، به معنای «زندگی میرا») آغاز می‌شود. در متون اوستایی کهن، کیومرث انسان به معنای متداول آن نیست، بلکه او «پیش‌نمونه‌ی کیهانی» (Prototype) انسان است که در کنار «گاو یکتاآفریده» (ایوداد) در زمین قرار دارد.

بر اساس بندهشن، اهورامزدا در نبرد کیهانی با اهریمن، کیومرث و گاو نخستین را می‌آفریند. با هجوم اهریمن و ورود مرگ و بیماری به جهان مادی، گاو نخستین می‌میرد و از نطفه پاک‌شده‌ی او در ماه، انواع حیوانات و گیاهان می‌رویند. سپس اهریمن، دیو مرگ (استویداد) را به سراغ کیومرث می‌فرستد. کیومرث کشته می‌شود، اما نطفه او که با تابش خورشید تصفیه شده، در دل خاک (سپندارمذ یا ایزدبانوی زمین) محفوظ می‌ماند. از اعضای بدن کیومرث پس از مرگ، فلزات گوناگون روی زمین شکل می‌گیرند.

### تبیین شباهت با اساطیر نوردیک (اسکاندیناوی)

یکی از برجسته‌ترین و کلیدی‌ترین تحلیل‌های کریستنسن در این بخش، اثبات ریشه‌های مشترک هندواروپایی این روایت از طریق مقایسه آن با اساطیر نوردیک است. کریستنسن کیومرث و گاو نخستین را قرینه‌ی ایرانیِ غول اولیه در اساطیر اسکاندیناوی یعنی «یمیر» (Ymir) و گاو کیهانی همراه او یعنی «اودوملا» (Auðumbla) می‌داند. این بن‌مایه (Motif) اثبات می‌کند که اسطوره آفرینش جهان از پیکر یک «غول کیهانیِ متلاشی‌شده»، میراثی مشترک میان اقوام هندوایرانی و نوردیک پیش از پراکندگی آن‌ها بوده است.
...
| نقش گاو کیهانی پس از مرگ | پیدایش گونه‌های مختلف حیوانات و گیاهان از نطفه تصفیه‌شده‌ی او در ماه | منبع حیات اولیه (تغذیه یمیر با شیر او) و پدیدآوردن نخستین خدایان با لیسیدن صخره‌های نمک |
...
پس از گذشت چهل سال از مرگ کیومرث، از نطفه‌ی او در زمین، گیاه «ریواس» دوگانه‌ای با پانزده برگ (نماد سن بلوغ اساطیری) می‌روید. این گیاه به تدریج به دو انسان متصل‌به‌هم تغییر شکل می‌دهد که جنسیت آن‌ها در ابتدا متمایز نبود. اهورامزدا جان را در کالبد آن‌ها می‌دمد و آن‌ها را مَشی و مَشیانه (در اوستا: مشیا و مشیانه) می‌نامد.
...
- **هوشنگ (پیشداد):** لقب او «پرداته» (Paradata) به معنای «نخستین آفریده/قانون‌گذار» است. کریستنسن معتقد است هوشنگ در اصل یک اسطوره‌ی محلی و مستقل مربوط به «نخستین انسان» در مناطق شمال ایران بوده که بعدها با تجمیع اساطیر، به عنوان نخستین پادشاه سلسله‌ی پیشدادیان در سیستم سراسری زرتشتی ادغام شده است. او دیوان را شکست می‌دهد، استخراج آهن و ساخت ابزار را پایه‌گذاری می‌کند و با کشف آتش، جشن سده را بنیان می‌نهد.
...
کتاب آرتور کریستنسن فراتر از یک گزارش تاریخی، یک کالبدشکافی عمیق از روان‌شناسی قوم ایرانی و تطور اندیشه‌ی دینی و ملی آنهاست. او به زیبایی نشان می‌دهد که اساطیر ایرانی موجوداتی ایستا نبوده‌اند؛ غول‌های پیش‌کیهانی هندواروپایی (مانند یمیر نوردیک) در ایران به پیش‌نمونه‌های انسانی (کیومرث) و پادشاهان تمدن‌ساز تبدیل شدند و ایزدان باستانی، جامه‌ی قهرمانان حماسی شاهنامه را به تن کردند. این کتاب شاه‌کلیدی برای فهم نمادها، ساختار شاهنامه فردوسی و ریشه‌شناسی اساطیر تمدن ایرانی در پیوند با جهان هندواروپایی است.

---

## منبع و ترجمهٔ فارسی

متن اصلیِ فرانسویِ کتاب به صورت رایگان در آرشیو اینترنت در دسترس است:
